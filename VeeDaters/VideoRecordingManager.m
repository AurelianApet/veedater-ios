...
- (void)saveCurrentRecordingVideoToPhotoLibrary {
    ...
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
        ...
        if (!error) {
            ...
            if (success == true) {
                NSLog(@"Save video in directory success!");
            ...
            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"VeeDaters"
                                                            message:@"Video not save. try again!"
                                                           delegate:self
