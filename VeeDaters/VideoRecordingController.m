...
- (void)setupTopToolBar {
    ...
    [crossBtn setImage:[UIImage imageNamed:@"cross"] forState:UIControlStateSelected];
    ...
    flashBtn.frame = CGRectMake(self.view.frame.size.width - btnmargin, margin, btnWH, btnWH);
...
- (void)saveVideoBtnBtnAction {
    ...
    UIAlertController * alert = [UIAlertController
                                 alertControllerWithTitle:@"VeeDaters"
    ...
    UIAlertAction* ok = [UIAlertAction
                         ...
                         handler:^(UIAlertAction * action) {
                             [self.delegate didFinishVideoRecordingController:self];
//                             [self dismissViewControllerAnimated:true completion:nil];
                         }];
